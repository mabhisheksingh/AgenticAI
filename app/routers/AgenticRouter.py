...
This module defines the REST API endpoints for chat interactions with AI ai_core,
...
async def create_and_update_chat(
    ...
    Handles chat interactions with AI ai_core, supporting both new conversation
